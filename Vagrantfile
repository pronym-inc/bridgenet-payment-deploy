...
Vagrant.configure("2") do |config|
    config.vm.synced_folder "src", "/webapps/bridgenet_payment/src"
    config.vm.define "main" do |all_in_one|
        all_in_one.vm.box = "ubuntu/bionic64"
        all_in_one.vm.network "private_network", ip: "192.168.70.3"
        ...
        all_in_one.vm.provision :ansible_local do |ansible|
            ...
            ansible.extra_vars = {
                ...
                server_name: "bridgenetpaymentvagrant.local",
                is_vagrant: true,
